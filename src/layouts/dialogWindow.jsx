...
function DialogWindow({visibleForm, children}){
    ...
    return (
        (visibleForm 
            ...
            <div id="formBackround" className="fixed inset-y-0 inset-x-0 flex justify-center overflow-hidden bg-[#ffffffd9] z-[9999]" onClick={hideWindow}>
                <div onClick={stopProp} id="formContent" className="bg-[#ffffff] p-0 min-w-[325px] md:min-w-[500px] mx-auto min-h-[610px] shadow-md rounded-md grid grid-rows-[0.25fr_0.50fr_auto] md:grid-rows-[0.15fr_0.70fr_auto]">
                    <div id="formHeader" class="flex flex-col justify-center">
